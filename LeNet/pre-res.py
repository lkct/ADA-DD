...
def main():
    ...
    print("Top1 result is: ", pred[0])
    print("Top5 result is: ", [pred[i] for i in range(5)])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--prefix', type=str, default='model/lenet-mnist-0', help='the prefix of the pre-trained model')
    parser.add_argument('--epoch', type=int, default=30, help='the epoch of the pre-trained model')
